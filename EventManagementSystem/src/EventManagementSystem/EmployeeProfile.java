...
public class EmployeeProfile extends javax.swing.JFrame {
    ...
    public EmployeeProfile(String emp_ID) {
        ...
        try {
            ...
            while (co.resultSet.next()) {
                idtf.setText(emp_ID);
                ntf.setText(co.resultSet.getString("Emp_Name"));
                etf.setText(co.resultSet.getString("Emp_email"));
                atf.setText(co.resultSet.getString("Emp_Password"));
                ptf.setText(co.resultSet.getString("Emp_Phone"));
    ...
    private void saActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saActionPerformed
        ...
        try{
            query="Update Employees set Emp_Name = '"+ntf.getText()+"',Emp_Password = '"+atf.getText()+"',Emp_Phone = '"+ptf.getText()+"' where Emp_ID = "+e_id;
            Statement st =co.connection.createStatement();
            st.executeUpdate(query);
            JOptionPane.showMessageDialog(this, "Profile Updated Successfully");
            query="select *from Employees where Emp_ID = "+e_id;
            co.resultSet = co.statement.executeQuery(query);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        this.dispose();
        new EmployeeHome(e_id).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeProfile("1").setVisible(true);
            }
        });
    }
